...
import { SignedUrlResponse, StorageDeleteResponse, StorageUploadResponse } from "../models/storage.model";
...
export class AdminStorageService {
  ...
  deleteClassificationDocument(userId: string) {
    return this.http.delete<StorageDeleteResponse>(
  ...
  deleteAvatar(userId: string) {
    return this.http.delete<StorageDeleteResponse>(
      ...
      {
        headers: this.getHeaders({ 'Content-Type': 'application/json' }),
        body: { prefixes: [`avatars/${userId}/avatar.jpg`] },
      }
    );
  }
}

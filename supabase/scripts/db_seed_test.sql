...
INSERT INTO auth.users (
  ...
  ('10000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.sofia.castro@panelatletas.test',       '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.mateo.jimenez@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.valeria.urena@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.diego.herrera@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000006','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.carlos.mora@panelatletas.test',        '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000007','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.luis.perez@panelatletas.test',         '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000008','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.martina.rojas@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000009','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.roberto.salas@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000010','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.patricia.vega@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000011','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.fernando.alvarado@panelatletas.test',  '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000012','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.ana.quesada@panelatletas.test',        '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000013','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.eduardo.madrigal@panelatletas.test',   '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000014','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.gabriela.chaves@panelatletas.test',    '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000015','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.andres.montoya@panelatletas.test',     '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000016','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.laura.obando@panelatletas.test',       '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000017','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.miguel.vargas@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000018','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.daniela.blanco@panelatletas.test',     '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000019','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.jose.mendez@panelatletas.test',        '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000020','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.melissa.campos@panelatletas.test',     '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000021','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.ricardo.soto@panelatletas.test',       '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000022','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.carolina.badilla@panelatletas.test',   '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000023','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.alejandro.castro@panelatletas.test',   '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000024','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.natalia.elizondo@panelatletas.test',   '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000025','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.pablo.acuna@panelatletas.test',        '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000026','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.stephanie.quiros@panelatletas.test',   '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000027','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.cristian.arce@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000028','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.pamela.fonseca@panelatletas.test',     '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000029','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.esteban.gutierrez@panelatletas.test',  '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000030','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.diana.mora@panelatletas.test',         '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000031','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.hector.picado@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000032','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.marcela.trejos@panelatletas.test',     '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}'),
  ('10000000-0000-0000-0000-000000000033','00000000-0000-0000-0000-000000000000','authenticated','authenticated','test.javier.ocampo@panelatletas.test',      '$2a$06$J2.GDBg/X1GF/bSL5XdUseFPbFACcWDwhkKFB07tV79SwaAHqqAsu',now(),'','','','',now(),now(),'{"provider":"email","providers":["email"]}','{}');

-- =============================================
-- AUTH IDENTITIES (email provider — required for password login)
-- provider_id = email, sub = user UUID
-- =============================================

INSERT INTO auth.identities (
  id, user_id, provider_id, provider, identity_data, last_sign_in_at, created_at, updated_at
) VALUES
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000002','test.sofia.castro@panelatletas.test',      'email','{"sub":"10000000-0000-0000-0000-000000000002","email":"test.sofia.castro@panelatletas.test","email_verified":true,"phone_verified":false}',       now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000003','test.mateo.jimenez@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000003","email":"test.mateo.jimenez@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000004','test.valeria.urena@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000004","email":"test.valeria.urena@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000005','test.diego.herrera@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000005","email":"test.diego.herrera@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000006','test.carlos.mora@panelatletas.test',       'email','{"sub":"10000000-0000-0000-0000-000000000006","email":"test.carlos.mora@panelatletas.test","email_verified":true,"phone_verified":false}',        now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000007','test.luis.perez@panelatletas.test',        'email','{"sub":"10000000-0000-0000-0000-000000000007","email":"test.luis.perez@panelatletas.test","email_verified":true,"phone_verified":false}',         now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000008','test.martina.rojas@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000008","email":"test.martina.rojas@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000009','test.roberto.salas@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000009","email":"test.roberto.salas@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000010','test.patricia.vega@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000010","email":"test.patricia.vega@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000011','test.fernando.alvarado@panelatletas.test', 'email','{"sub":"10000000-0000-0000-0000-000000000011","email":"test.fernando.alvarado@panelatletas.test","email_verified":true,"phone_verified":false}',  now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000012','test.ana.quesada@panelatletas.test',       'email','{"sub":"10000000-0000-0000-0000-000000000012","email":"test.ana.quesada@panelatletas.test","email_verified":true,"phone_verified":false}',        now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000013','test.eduardo.madrigal@panelatletas.test',  'email','{"sub":"10000000-0000-0000-0000-000000000013","email":"test.eduardo.madrigal@panelatletas.test","email_verified":true,"phone_verified":false}',   now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000014','test.gabriela.chaves@panelatletas.test',   'email','{"sub":"10000000-0000-0000-0000-000000000014","email":"test.gabriela.chaves@panelatletas.test","email_verified":true,"phone_verified":false}',    now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000015','test.andres.montoya@panelatletas.test',    'email','{"sub":"10000000-0000-0000-0000-000000000015","email":"test.andres.montoya@panelatletas.test","email_verified":true,"phone_verified":false}',     now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000016','test.laura.obando@panelatletas.test',      'email','{"sub":"10000000-0000-0000-0000-000000000016","email":"test.laura.obando@panelatletas.test","email_verified":true,"phone_verified":false}',       now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000017','test.miguel.vargas@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000017","email":"test.miguel.vargas@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000018','test.daniela.blanco@panelatletas.test',    'email','{"sub":"10000000-0000-0000-0000-000000000018","email":"test.daniela.blanco@panelatletas.test","email_verified":true,"phone_verified":false}',     now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000019','test.jose.mendez@panelatletas.test',       'email','{"sub":"10000000-0000-0000-0000-000000000019","email":"test.jose.mendez@panelatletas.test","email_verified":true,"phone_verified":false}',        now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000020','test.melissa.campos@panelatletas.test',    'email','{"sub":"10000000-0000-0000-0000-000000000020","email":"test.melissa.campos@panelatletas.test","email_verified":true,"phone_verified":false}',     now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000021','test.ricardo.soto@panelatletas.test',      'email','{"sub":"10000000-0000-0000-0000-000000000021","email":"test.ricardo.soto@panelatletas.test","email_verified":true,"phone_verified":false}',       now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000022','test.carolina.badilla@panelatletas.test',  'email','{"sub":"10000000-0000-0000-0000-000000000022","email":"test.carolina.badilla@panelatletas.test","email_verified":true,"phone_verified":false}',   now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000023','test.alejandro.castro@panelatletas.test',  'email','{"sub":"10000000-0000-0000-0000-000000000023","email":"test.alejandro.castro@panelatletas.test","email_verified":true,"phone_verified":false}',   now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000024','test.natalia.elizondo@panelatletas.test',  'email','{"sub":"10000000-0000-0000-0000-000000000024","email":"test.natalia.elizondo@panelatletas.test","email_verified":true,"phone_verified":false}',   now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000025','test.pablo.acuna@panelatletas.test',       'email','{"sub":"10000000-0000-0000-0000-000000000025","email":"test.pablo.acuna@panelatletas.test","email_verified":true,"phone_verified":false}',        now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000026','test.stephanie.quiros@panelatletas.test',  'email','{"sub":"10000000-0000-0000-0000-000000000026","email":"test.stephanie.quiros@panelatletas.test","email_verified":true,"phone_verified":false}',   now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000027','test.cristian.arce@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000027","email":"test.cristian.arce@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000028','test.pamela.fonseca@panelatletas.test',    'email','{"sub":"10000000-0000-0000-0000-000000000028","email":"test.pamela.fonseca@panelatletas.test","email_verified":true,"phone_verified":false}',     now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000029','test.esteban.gutierrez@panelatletas.test', 'email','{"sub":"10000000-0000-0000-0000-000000000029","email":"test.esteban.gutierrez@panelatletas.test","email_verified":true,"phone_verified":false}',  now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000030','test.diana.mora@panelatletas.test',        'email','{"sub":"10000000-0000-0000-0000-000000000030","email":"test.diana.mora@panelatletas.test","email_verified":true,"phone_verified":false}',         now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000031','test.hector.picado@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000031","email":"test.hector.picado@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000032','test.marcela.trejos@panelatletas.test',    'email','{"sub":"10000000-0000-0000-0000-000000000032","email":"test.marcela.trejos@panelatletas.test","email_verified":true,"phone_verified":false}',     now(),now(),now()),
  (gen_random_uuid(),'10000000-0000-0000-0000-000000000033','test.javier.ocampo@panelatletas.test',     'email','{"sub":"10000000-0000-0000-0000-000000000033","email":"test.javier.ocampo@panelatletas.test","email_verified":true,"phone_verified":false}',      now(),now(),now());
